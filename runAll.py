...
class AllTest:  # 定义一个类AllTest
    def __init__(self):  # 初始化一些参数和数据
        ...
        resultPath = os.path.join(report_path, now_date+"-report.html")  # result/report.html
        ...
        log.info(self.caseListFile)#同上
        log.info(self.caseList)#同上
    ...
    def run(self):
        ...
        # 判断邮件发送的开关
        if on_off == 'on':
            send_mail.send_mails(resultPath)
            #send_mail.outlook()
        else:
